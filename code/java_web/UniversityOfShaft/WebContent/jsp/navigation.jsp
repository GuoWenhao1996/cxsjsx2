...
<div id="wrapper">
    <nav class="navbar navbar-default top-navbar" role="navigation">
        <div class="navbar-header">
            ...
            <a class="navbar-brand waves-effect waves-dark" href="#"><i class="large material-icons">trending_up</i>
                <strong>大学轴</strong></a>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu waves-effect waves-dark" name="lead" href="PersonalData.jsp" target="mainFrame" onclick="javascript:changetitle('个人资料',this)"><i
                            class="fa fa-dashboard"></i>
                        个人资料</a>
                </li>
                <li>
                    <a id="qw" href="ScoreQuery.jsp" class="waves-effect waves-dark" name="lead" target="mainFrame" onclick="javascript:changetitle('成绩查询',this)"><i class="fa fa-desktop"></i> 成绩查询</a>
                </li>
                <li>
                ...
                <li>
                    <a href="RewardsAndPunishment.jsp" class="waves-effect waves-dark" name="lead" target="mainFrame" onclick="javascript:changetitle('奖惩',this)"><i class="fa fa-table"></i>
                        奖惩</a>
                </li>
                <li>
                ...
                <li>
                    <a href="empty.jsp" class="waves-effect waves-dark" name="lead" target="mainFrame" onclick="javascript:changetitle('空白页',this)"><i class="fa fa-fw fa-file"></i> 空白页 </a>
                </li>
            </ul>
