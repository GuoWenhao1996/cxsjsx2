...
<head>
    ...
    <title>服务器错误</title>
    <link rel="shortcut icon" href="${path}assets/img/50x.png"/>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="empty.jsp" class="active-menu waves-effect waves-dark"><i class="fa fa-fw fa-file"></i>
                        空白页 </a>
                </li>
    ...
    <div id="page-wrapper">
        <div class="header">
            <h1 class="page-header">
                &nbsp;<i class="medium material-icons circle  red">language</i>
                很抱歉，服务器错误！
            </h1>
            <ol class="breadcrumb">
