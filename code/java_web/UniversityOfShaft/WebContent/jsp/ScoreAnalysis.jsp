...
<body>
	...
	<div id="wrapper">
		<div id="page-wrapper">
			...
			<div margin:0 auto>
            <label>学  期  数：</label>
            <button><a href="/UniversityOfShaft/Analysisscore.do?term=1">1</a></button>
            <button><a href="/UniversityOfShaft/Analysisscore.do?term=2">2</a></button>
            <button><a href="/UniversityOfShaft/Analysisscore.do?term=3">3</a></button>
            <button><a href="/UniversityOfShaft/Analysisscore.do?term=4">4</a></button>
            <button><a href="/UniversityOfShaft/Analysisscore.do?term=5">5</a></button>
            <button><a href="/UniversityOfShaft/Analysisscore.do?term=6">6</a></button>
            <button><a href="/UniversityOfShaft/Analysisscore.do?term=7">7</a></button>
            <button><a href="/UniversityOfShaft/Analysisscore.do?term=8">8</a></button>
            </div>
